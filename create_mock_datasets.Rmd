...
First load the data. This is a list of SingleCellExperiment-assays (as created after "minimal_preprocessing" and "preprocessing_continued").
...
For the rest of the analyses, we will use "sces" (the real data), and "sces_subset_split" and "sces_subset_split_per_run" (the mock data).
